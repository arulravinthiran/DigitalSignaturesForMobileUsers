...
public class EmailAddress implements Serializable {
	...
	private static final long serialVersionUID = 1911677992397927067L;
...
Its default value is true to remain RFC 2822 compliant, but
	...
	public EmailAddress(String text) throws InvalidInputException {
		super();
		setText(text);
	}
	...
	private void setText(String text) throws InvalidInputException{
		this.text = text;
		if (!isValid()) throw new InvalidInputException("Not a valid email address");
	}
