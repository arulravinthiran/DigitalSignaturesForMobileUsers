...
public class BCRSAPublicKey implements RSAPublicKey
{
    ...
    private void populateFromPublicKeyInfo(SubjectPublicKeyInfo info)
    {
        try
        {
            org.bouncycastle.asn1.pkcs.RSAPublicKey  pubKey = 
            	org.bouncycastle.asn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier, 
        		new org.bouncycastle.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
